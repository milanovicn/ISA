...
public class SearchPharmacist {
    ...
    public SearchPharmacist(String firstname, String lastname, String email, String address, String city, double rateTo, double rateFrom) {
