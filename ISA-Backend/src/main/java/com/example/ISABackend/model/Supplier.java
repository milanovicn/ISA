...
public class Supplier {
    ...
    public Supplier(String firstName, String lastName, String email, String phoneNumber, String password, String address, String city, String country, UserRole userRole, boolean prviPutLogovan) {
